...
struct JsonValue{
	...
	JsonValue(const JsonValue& other)
		...
		if (type == JsonValueType::Object) {
			try {
				...
				for (auto& cleanup_kv : object_value) {
					delete cleanup_kv.second;
				}
				object_value.clear();
				throw;
			}
	...
	JsonValue(JsonValue&& other) noexcept
		: type(other.type), boolean_value(other.boolean_value), number_value(other.number_value), string_value(std::move(other.string_value)), array_value(std::move(other.array_value)), object_value(std::move(other.object_value)) {
